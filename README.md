# React based streetview equirectangular image API
link: https://stview-react-api.now.sh/

## API endpoint accepts two variables
`lat = latitude in float`
`lng = longitude in float`

## example request
https://stview-react-api.now.sh/?lat=35.7282487&lng=139.7590197

### below is the CRA default readme
